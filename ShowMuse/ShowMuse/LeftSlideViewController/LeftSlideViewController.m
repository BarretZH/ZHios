...
{
    return [self.mainVC supportedInterfaceOrientations];
}
...
-(void)handeTap:(UITapGestureRecognizer *)tap{
    ...
    {
//        [MainNetWorking userDataNetWorkComplete:^(id json, NSError *error) {
//            if (error == nil) {
...
//    LeftSortsViewController * VC = [[LeftSortsViewController alloc] init];
//    VC.str = @"123";
//    [VC showmuse];
    [[NSNotificationCenter defaultCenter]postNotificationName:@"userData" object:nil userInfo:nil];
    [UIView beginAnimations:nil context:nil];
