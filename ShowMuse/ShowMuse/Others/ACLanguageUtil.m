...
//        SMLog(@"************%@",preferredLang);
        if ([preferredLang containsString:@"zh-Hans"]) {
            ACLanguageUtilDefaultLanguage = @"zh-Hans";
        }else if ([preferredLang containsString:@"zh-Hant"] || [preferredLang containsString:@"zh-HK"] || [preferredLang containsString:@"zh-TW"]) {
            ACLanguageUtilDefaultLanguage = @"zh-Hant";
        }else {
            ACLanguageUtilDefaultLanguage = @"en";
        }
